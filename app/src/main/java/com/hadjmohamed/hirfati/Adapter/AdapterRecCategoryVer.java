...
import com.hadjmohamed.hirfati.Adapter.Holder.HolderRecCategory;
...
public class AdapterRecCategoryVer extends RecyclerView.Adapter<HolderRecCategory> {
    ...
    public AdapterRecCategoryVer(Context context, List<Crafts> craftsList, RecViewInterface recViewInterface) {
